(function () {
    ...
    var configure = function () {
        app.configure(CONFIG_FILENAME, function (err) {
            ...
            setTimeout(function () {
                ...
                window.addEventListener('resize', pcLaunchPage.reflow, false);
                window.addEventListener('orientationchange', pcLaunchPage.reflow, false);
    ...
    window.pcLauchPage = pcLaunchPage;
